 ...
 * on 2017-02-19 at 23:40:57 UTC 
 * Modify at your own risk.
 */

package com.udacity.gradle.builditbiggerbackend.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://javajokes-159005.appspot.com/_ah/api/";
   ...
   * @return the request
   */
  public SayHi sayHi(java.lang.String joke) throws java.io.IOException {
    SayHi result = new SayHi(joke);
    initialize(result);
    return result;
  }

  public class SayHi extends MyApiRequest<com.udacity.gradle.builditbiggerbackend.backend.myApi.model.MyBean> {
     ...
     * @since 1.13
     */
    protected SayHi(java.lang.String joke) {
      super(MyApi.this, "POST", REST_PATH, null, com.udacity.gradle.builditbiggerbackend.backend.myApi.model.MyBean.class);
    ...
    public SayHi setJoke(java.lang.String joke) {
      this.joke = joke;
      return this;
    }
